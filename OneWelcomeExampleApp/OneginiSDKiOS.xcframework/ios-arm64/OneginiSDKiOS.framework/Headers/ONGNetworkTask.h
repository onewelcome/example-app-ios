 ...
 * Produced by `-[ONGUserClient fetchResource:completion:]`, `-[ONGDeviceClient fetchResource:completion:]` and `-[ONGDeviceClient fetchUnauthenticatedResource:completion:]`.
 *
 * @see ONGUserClient, ONGDeviceClient
 */
DEPRECATED_MSG_ATTRIBUTE("Please use `NetworkTask` protocol instead.")
...
/**
 * The request, provided to the `-[ONGUserClient fetchResource:completion:]`, `-[ONGDeviceClient fetchResource:completion:]` and `-[ONGDeviceClient fetchUnauthenticatedResource:completion:]`.
 */
 ...
 * calling `-[ONGUserClient fetchResource:completion:]`, `-[ONGDeviceClient fetchResource:completion:]` or `-[ONGDeviceClient fetchUnauthenticatedResource:completion:]`.
 */
