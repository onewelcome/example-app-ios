...
ONG_EXTERN NSString *const ONGServerType;
ONG_EXTERN NSString *const ONGServerVersion;
 ...
 */
DEPRECATED_MSG_ATTRIBUTE("Please use `ConfigModel` protocol instead.")
 ...
 *  Server type.
 */
@property (nonatomic, readonly) NSString *serverType;
